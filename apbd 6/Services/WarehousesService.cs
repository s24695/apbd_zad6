...
public class WarehousesService : IWarehousesService
{
        ...
        private async Task InsertProductWarehouse(SqlCommand command, ProductWarehouse productWarehouse, double price, int idOrder)
        {
            ...
            if (rowsInserted < 1) throw new Exception(); // TODO: Custom Exception
